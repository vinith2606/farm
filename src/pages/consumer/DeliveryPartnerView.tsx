...
type Partner = { name: string; email: string; phone: string; avatar?: string; vehicleType?: string; vehicleNumber?: string; availabilityStatus?: string }
